...
silPAM=data.frame(res.pam$silinfo$heights)
silPAM$country=row.names(silPAM)
poorPAM=silPAM[silPAM$sil_height<0,'country']%>%sort()
```
...
silAGNES=data.frame(res.agnes$silinfo$heights)
silAGNES$country=row.names(silAGNES)
#poorAGNES=silAGNES[silAGNES$sil_height<0,'country']%>%sort()
#poorAGNES
```
